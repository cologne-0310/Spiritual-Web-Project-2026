        ...
        function getInitialPresetData() {
            return [
                { 
                    ...
                    mindStatus: 'red', 
                    mindNote: '焦慮不振',
                    history: '近期睡眠品質極差，每晚睡不到4小時。伴隨肌肉緊繃與頭痛等生理不適主訴。患者時常擔心退休收入不敷使用，心理焦慮偏高，對音療有興趣。',
                    prescription: '1. 安排 432Hz 頌缽音療課程放鬆神經 (評估契合度: 92%)\n2. 每日補充 1500ml 溫水並進行戶外散步 30 分鐘 (評估契合度: 85%)'
                },
                { 
                    id: 'C002', 
                    name: '暖心媽', 
                    ...
                    mindStatus: 'yellow', 
                    mindNote: '有些掛念',
                    history: '日常生活極有規律，有固定早晨瑜珈與散步習慣。近期因為子女工作調動，心情有些許掛念與擔憂，其餘生理指數皆良好。',
                    prescription: '1. 建議使用薰衣草香氛進行睡前冥想 (評估契合度: 88%)\n2. 持續保持現有早晨運動習慣 (評估契合度: 95%)'
                },
                { 
                    id: 'C003', 
                    name: '張爺爺', 
                    ...
                    mindStatus: 'green', 
                    mindNote: '心情平穩',
                    history: '平日作息正常，注重清淡飲食。但因季節交替血壓有些波動。心理層面極度平穩，喜愛品茗與社交聊天。',
                    prescription: '1. 建議定期監測血壓，並維持清淡低鹽飲食 (評估契合度: 90%)\n2. 安排溫和的太極拳體驗課程以舒緩心血管 (評估契合度: 80%)'
                },
                { 
                    id: 'C004', 
                    name: '快樂阿嬤', 
                    ...
                    mindStatus: 'green', 
                    mindNote: '樂觀開朗',
                    history: '心情保持極佳的樂觀態度，但平日水分攝取偏低，且偶爾有關節痠痛腫脹的主訴。喜歡烘焙手作活動。',
                    prescription: '1. 提醒每日飲水量需達到 1200ml 以上 (評估契合度: 95%)\n2. 推薦低衝擊水中有氧活動或局部熱敷課程 (評估契合度: 85%)'
                },
                { 
                    id: 'C005', 
                    name: '養生達人', 
                    ...
                    mindStatus: 'green', 
                    mindNote: '正念生活',
                    history: '生活習慣非常健康，每日練習太極拳與修剪花木。主訴身體狀況良好，心情愉悅穩定，無任何慢性病抱怨。',
                ...
                { 
                    ...
                    mindStatus: 'red', 
                    mindNote: '嚴重焦慮',
                    history: '獨居長者，平時缺乏運動且有水分不足問題。睡眠品質差，且伴隨輕度失智與健忘症狀。心情時常感到低落、孤獨與焦慮不振。',
                    prescription: '1. 安排古典音樂正念聆聽以安定神智 (評估契合度: 94%)\n2. 建議健管師增加關懷拜訪頻率 (評估契合度: 90%)'
                }
            ];
        }
        ...
        function switchSystemMode(val) {
            ...
            if (val === 'PLATFORM') {
                ...
                if (val === 'B1') {
                    ...
                    tenantTitle.innerText = "暖光苑樂齡健管中心"; 
